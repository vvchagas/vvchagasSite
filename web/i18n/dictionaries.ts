...
export const dictionaries = {
  pt: {
    ...
    contact: {
      ...
      formEmailPlaceholder: "Ex: maria@email.com",
      formEmailError: "Digite um e-mail válido (ex: nome@dominio.com).",
      formPhone: "Seu telefone",
      formPhonePlaceholder: "Ex: 99999-9999",
      formPhoneError: "Digite um telefone válido pro DDI selecionado.",
      formPhoneDdiLabel: "DDI",
      formContactType: "Como você prefere ser contatado?",
      formContactTypeEmail: "E-mail",
      formContactTypePhone: "Telefone",
      formSubject: "Assunto",
      formSubjectWeb: "Web",
      formSubjectIT: "TI",
  ...
  en: {
    ...
    contact: {
      ...
      formEmailPlaceholder: "Ex: mary@email.com",
      formEmailError: "Enter a valid email (ex: name@domain.com).",
      formPhone: "Your phone",
      formPhonePlaceholder: "Ex: 99999-9999",
      formPhoneError: "Enter a valid phone number for the selected country code.",
      formPhoneDdiLabel: "Country code",
      formSubject: "Subject",
      formSubjectWeb: "Web",
      formSubjectIT: "IT",
