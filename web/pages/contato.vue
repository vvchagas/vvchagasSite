      ...
      >
        ...
        >
          ...
          <a
            ...
            class="contact-cta contact-cta--whatsapp mx-auto mt-5 flex w-fit items-center justify-center rounded-md bg-green-600 px-6 py-2.5 text-center text-white sm:mt-6 text-sm sm:text-base"
          >
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="contact-cta contact-cta--linkedin mx-auto mt-5 flex w-fit items-center justify-center rounded-md bg-blue-600 px-6 py-2.5 text-center text-white sm:mt-6 text-sm sm:text-base"
          >
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="contact-cta contact-cta--email mx-auto mt-5 flex w-fit items-center justify-center rounded-md bg-red-600 px-6 py-2.5 text-center text-white sm:mt-6 text-sm sm:text-base"
          >
            {{ t('contact.emailBtn') }}
          </a>
        </div>
        ...
        <div>
          <h2 class="mt-10 text-base sm:text-lg text-center font-bold">
            {{ t('contact.formIntro') }}
          </h2>
        </div>
        <div
