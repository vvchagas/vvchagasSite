import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineAsyncComponent, defineComponent, ref, h, Suspense, Fragment, useSSRContext, createApp, provide, shallowReactive, watch, nextTick, mergeProps, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, getCurrentScope, toRef, shallowRef, isReadonly, computed, isRef, isShallow, isReactive, toRaw } from 'vue';
import { s as parseURL, k as encodePath, v as decodePath, x as klona, c as createError$1, y as hasProtocol, z as isScriptProtocol, A as joinURL, w as withQuery, B as defuFn, C as sanitizeStatusCode, D as getContext, $ as $fetch$1, E as baseURL, F as executeAsync, G as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "contato",
    path: "/contato",
    component: () => import('./contato-jQ3E0UvJ.mjs')
  },
  {
    name: "messages",
    path: "/messages",
    component: () => import('./messages-C4UvZ5ET.mjs')
  },
  {
    name: "servicos",
    path: "/servicos",
    component: () => import('./servicos-7Le0zh5a.mjs')
  },
  {
    name: "sobre",
    path: "/sobre",
    component: () => import('./sobre-KR8xoTP3.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DDb0w0So.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-1G4qXNdh.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CsX20wT7.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B9XkV45X.mjs'));
...
export { useRoute as a, useNuxtApp as b, useRouter as c, useRuntimeConfig as d, entry_default as default, encodeRoutePath as e, fetchDefaults as f, nuxtLinkDefaults as g, useAppConfig as h, asyncDataDefaults as i, createError as j, navigateTo as n, resolveRouteObject as r, useHead as u };
